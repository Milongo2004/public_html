...
//pregunto en la base de datos cuál es el ultimo codigo de rótulo creado.
		...
		$sql1="SELECT cod_rotulo FROM rotulos2 ORDER BY id DESC LIMIT 1";

$result1=mysqli_query($conexion,$sql1);

while($mostrar1=mysqli_fetch_array($result1)){
                    $creaRotulo=$mostrar1['cod_rotulo'];    
		...
		$sql2="SELECT casillaId FROM rotulos2 WHERE cod_rotulo = '".$cod_rotulo. "'";
...
while($mostrar2=mysqli_fetch_array($result2)){
            ...
            $sql21="SELECT cantidadMoldes FROM rotulos2 WHERE cod_rotulo = '".$cod_rotulo. "'";
...
$ingresar_juegos = $herramienta13->ingresar_juegos_vueltas($juegos,$moldeId,$rotuloMolde,$vuelta1,$vuelta2,$vuelta3,$vuelta4,$vuelta5,$vuelta6,$vuelta7,$vuelta8);
	...
	case '6':
		...
		$sql6="UPDATE rotulos2 SET estacionId2 = '".$estacion. "'"." WHERE cod_rotulo = '". $cod_rotulo."'";
...
while($mostrar7=mysqli_fetch_array($result7)){
		...
		$sql8="UPDATE rotulos2 SET estacionId2 = '".$estacion. "'"." , fechaActualizacion = (select DATE_SUB(NOW(),INTERVAL 5 HOUR)) WHERE cod_rotulo = '". $rotulos[$i]."'";//; INSERT INTO `rotuloestaciones2` (`id`, `rotuloId2`, `estacionId`, `ingreso`, `estado`) VALUES (NULL, '". $rotulos[$i]."', '".$estacion. "', current_timestamp(), '') ";
...
// consulta para registrar la hora de entrada en cada estación
	...
	$sql81="INSERT INTO `rotuloestaciones2` (`id`, `rotuloId2`, `estacionId`, `ingreso`, `estado`) VALUES (NULL, '". $rotulos[$i]."', '".$estacion. "', (select DATE_SUB(NOW(),INTERVAL 5 HOUR)), '') ";
...
//comento lo siguiente porque no se están usando los moldes disponibles ni lo moldes en uso.

/*$sqlM= "SELECT totalMoldes, moldesEnUso FROM referencias2 WHERE id = '". $refRotulo. "'";
        ...
        $resultU=mysqli_query($conexion,$sqlU);         
            ...
            */
            ...
            //cuento los rótulos existentes desde el rotulo ingresado con el teclado.
             ...
             $sqlU= "SELECT COUNT(id) AS cuantosRotulos FROM rotulos2 WHERE cod_rotulo >= '$cod_rotulo'";
...
//consulto los codigos de rótulo y los id de referencias
		...
		$sql9="SELECT cod_rotulo, referenciaId FROM rotulos2 WHERE cod_rotulo >= '$cod_rotulo' ORDER BY id ASC LIMIT $i";

$result9=mysqli_query($conexion,$sql9);

//$k=0;
while($mostrar9=mysqli_fetch_array($result9)){
                    $codRotulo[$i-1]=$mostrar9['cod_rotulo'];   
