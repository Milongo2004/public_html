    ...
    <?php
        ...
        <div class="row">
            ...
            <div class="mb-3">
                    ...
                    <select class="form-select" id="caja" name="caja" aria-label="Default select example">
    ...
    <div class="row">
            ...
            <div class="mb-3">
                ...
                <label for="antPos" class="form-label">Ant/Pos</label>
                    <select class="form-select" autofocus id="antPos" name="antPos" aria-label="Default select example">
